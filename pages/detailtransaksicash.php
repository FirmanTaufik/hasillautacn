              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table  ">
                    ...
                    <tr> 
                        <td colspan="5"><b style="float:right;">Discount:</b></td>
                        <td><b><?php echo  $hDiscount; ?>%</b></td>
                    </tr>
                    <tr> 
                        <?php $tot = $total-($total*$hDiscount/100); ?>
                        <td colspan="5"><b style="float:right;">Total Biaya:</b></td>
                        <td><b><?php echo  c($tot); ?></b></td>
                    </tr>
                      <tr> 
                          <td   colspan="5"><b style="float:right;">Uang:</b></td>
                          <?php 
                             $qwqwq = mysqli_fetch_assoc(mysqli_query($conn ,"SELECT  *from tb_kredit_bayar WHERE idTransaksi  = '$id' ")); 
                             
                          ?>
                            <td><b><?php echo   c(  $qwqwq['telahBayar']) ; ?></b></td>
                      </tr>
                      <tr> 
                            <td   colspan="5"><b style="float:right;">Kembali:</b></td>
                            <td><b><?php echo convert_to_rupiah(  $qwqwq['telahBayar']-$tot); ?></b></td>
                        </tr>
                  </table>
                </div>
                <!-- /.col -->
